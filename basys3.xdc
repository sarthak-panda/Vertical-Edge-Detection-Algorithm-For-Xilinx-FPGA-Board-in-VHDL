...
## Input Delay
#set_input_delay -clock [get_ports pclk] 3 [get_ports rst]

## Output Delay
#set_output_delay -clock [get_ports pclk] 3 [get_ports en]
#set_output_delay -clock [get_ports pclk] 3 [get_ports hcnt]

 #Clock signal
set_property PACKAGE_PIN W5 [get_ports BASYS_clk_100MHz]                                                    
        set_property IOSTANDARD LVCMOS33 [get_ports BASYS_clk_100MHz]
        create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports BASYS_clk_100MHz]
 
## Switches
##set_property PACKAGE_PIN V17 [get_ports {old_or_new}]                                       
        #set_property IOSTANDARD LVCMOS33 [get_ports {old_or_new}]
